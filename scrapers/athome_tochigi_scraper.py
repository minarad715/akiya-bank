...
class AthomeTochigiScraper(BaseScraper):
    """アットホーム栃木の空き家バンクスクレイパー"""
    
    def __init__(self):
        super().__init__(
            municipality_name="栃木県（アットホーム）",
            base_url="https://www.akiya-athome.jp/buy/09/"
        )
        ...
        for link in links:
            ...
            if '/bukken/detail/buy/' in href:
                ...
                property_data = {
                    ...
                    'municipality': f"栃木県{municipality_code}",
                    'url': href,
                    'type': '売買',
                    'price': price,
                    'price_raw': price_raw,
    ...
    def run(self):
        ...
        output_path = '../data/raw/athome_tochigi.json'
        self.save_data(output_path)
        
        return self.properties

if __name__ == '__main__':
    scraper = AthomeTochigiScraper()
    scraper.run()