...
class AthomeChibaScraper(BaseScraper):
    """アットホーム千葉県の空き家バンクスクレイパー"""
    
    def __init__(self):
        super().__init__(
            municipality_name="千葉県（アットホーム）",
            base_url="https://www.akiya-athome.jp/buy/12/"
        )
    ...
    def run(self):
        ...
        output_path = '../../data/raw/athome_chiba.json'
        self.save_data(output_path)
        
        return self.properties

if __name__ == '__main__':
    scraper = AthomeChibaScraper()
    scraper.run()