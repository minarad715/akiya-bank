...
class AthomeHokkaidoScraper(BaseScraper):
    """アットホーム北海道の空き家バンクスクレイパー"""
    
    def __init__(self):
        super().__init__(
            municipality_name="北海道（アットホーム）",
            base_url="https://www.akiya-athome.jp/buy/01/"
        )
    ...
    def run(self):
        ...
        output_path = '../../data/raw/athome_hokkaido.json'
        self.save_data(output_path)
        
        return self.properties

if __name__ == '__main__':
    scraper = AthomeHokkaidoScraper()
    scraper.run()