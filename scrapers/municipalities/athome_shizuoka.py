...
class AthomeShizuokaScraper(BaseScraper):
    """アットホーム静岡県の空き家バンクスクレイパー"""
    
    def __init__(self):
        super().__init__(
            municipality_name="静岡県（アットホーム）",
            base_url="https://www.akiya-athome.jp/buy/22/"
        )
    ...
    def run(self):
        ...
        output_path = '../../data/raw/athome_shizuoka.json'
        self.save_data(output_path)
        
        return self.properties

if __name__ == '__main__':
    scraper = AthomeShizuokaScraper()
    scraper.run()