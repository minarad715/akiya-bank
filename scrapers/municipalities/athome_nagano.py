...
class AthomeNaganoScraper(BaseScraper):
    """アットホーム長野県の空き家バンクスクレイパー"""
    
    def __init__(self):
        super().__init__(
            municipality_name="長野県（アットホーム）",
            base_url="https://www.akiya-athome.jp/buy/20/"
        )
    ...
    def run(self):
        ...
        output_path = '../../data/raw/athome_nagano.json'
        self.save_data(output_path)
        
        return self.properties

if __name__ == '__main__':
    scraper = AthomeNaganoScraper()
    scraper.run()