...
class AthomeYamanashiScraper(BaseScraper):
    """アットホーム長野県の空き家バンクスクレイパー"""
    
    def __init__(self):
        super().__init__(
            municipality_name="山梨県（アットホーム）",
            base_url="https://www.akiya-athome.jp/buy/19/"
        )
        ...
        for link in links:
            ...
            if '/bukken/detail/buy/' in href:
                ...
                property_data = {
                    ...
                    'municipality': f"長野県{municipality_code}",
                    'url': href,
                    'type': '売買',
                    'price': price,
                    'price_raw': price_raw,
    ...
    def run(self):
        ...
        output_path = '../../data/raw/athome_yamanashi.json'
        self.save_data(output_path)
        
        return self.properties

if __name__ == '__main__':
    scraper = AthomeYamanashiScraper()
    scraper.run()