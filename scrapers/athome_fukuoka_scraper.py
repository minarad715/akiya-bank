...
class AthomefukuokaScraper(BaseScraper):
    """アットホーム福岡の空き家バンクスクレイパー"""
    
    def __init__(self):
        super().__init__(
            municipality_name="福岡県（アットホーム）",
            base_url="https://www.akiya-athome.jp/buy/40/"
        )
        ...
        for link in links:
            ...
            if '/bukken/detail/buy/' in href:
                ...
                property_data = {
                    ...
                    'municipality': f"福岡県{municipality_code}",
                    'url': href,
                    'type': '売買',
                    'price': price,
                    'price_raw': price_raw,
    ...
    def run(self):
        ...
        output_path = '../data/raw/athome_fukuoka.json'
        self.save_data(output_path)
        
        return self.properties

if __name__ == '__main__':
    scraper = AthomefukuokaScraper()
    scraper.run()